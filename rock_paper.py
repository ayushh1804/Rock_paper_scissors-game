...
root.config(bg = '#003380')

# title
Label(root, text = 'Rock-Paper-Scissors' , font='ALEGREYA 20 bold', bg = '#003380').pack()

#choice of user
user_take = StringVar()
Label(root, text = 'choose any one: rock, paper ,scissors' , font='arial 15 bold', bg = '#0099cc').place(x = 20,y=70)
...
def play():
    ...
    if user_pick == comp_pick:
        ...
        Result.set('invalid: choose any one -- rock, paper or scissors')
...
###### button
Entry(root, font = 'arial 10 bold', textvariable = Result, bg ='antiquewhite2',width = 40,).place(x=70 , y = 250)

Button(root, font = 'arial 13 bold', text = 'PLAY'  ,padx =5,bg ='seashell4' ,command = play).place(x=170,y=190)
